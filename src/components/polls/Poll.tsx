              ...
              <div className="space-y-4">
                {pollData.options.map((option: PollOption, i) => (
                  ...
                  >
                    ...
                    <Progress
                      value={(option.votes_count / totalVotes) * 100}
                ...
                {pollData.options.map((option: PollOption, i) => (
                  ...
                  >
                    ...
                    <Label
                      ...
                      className="flex-1 p-4 cursor-pointer text-blue-800"
                    >
                      {option.text}
                    </Label>
                  </motion.div>
              ...
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button
                    ...
                    } w-full py-6 text-lg font-semibold bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white transition-all duration-300 ease-in-out transform hover:scale-105`}
