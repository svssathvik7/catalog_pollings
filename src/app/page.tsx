...
export default function Home() {
  return (
    <Tabs defaultValue="live-polls" className="w-full text-center flex items-center justify-start flex-col">
      ...
      <TabsContent value="live-polls" className="h-[80dvh] overflow-y-scroll">
        <LivePollContainer/>
      </TabsContent>
